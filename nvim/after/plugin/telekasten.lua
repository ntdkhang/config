local default_home = vim.fn.expand("/Users/dk/Documents/Personal/Notes/All")
local journal_home = vim.fn.expand("/Users/dk/Documents/Personal/Notes/journal")
...
require('telekasten').setup({
    ...
    template_new_note = default_home .. '/' .. 'templates/new_note.md',
    ...
    vaults = {
        journal = {
            ...
            dailies      = journal_home .. '/' .. 'daily',
            weeklies     = journal_home .. '/' .. 'weekly',
            templates    = journal_home .. '/' .. 'templates',
            ...
            -- template for newly created daily notes (goto_today)
            -- set to `nil` or do not specify if you do not want a template
            template_new_daily = journal_home .. '/' .. 'templates/daily.md',

            -- template for newly created weekly notes (goto_thisweek)
            -- set to `nil` or do not specify if you do not want a template
            template_new_weekly= journal_home .. '/' .. 'templates/weekly.md',
        },
    },
